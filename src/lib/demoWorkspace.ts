  ...
  aiLensItems: [
    {
      ...
      targetId: "edge-lead",
      title: "問い合わせ後の継続接点",
      body: "問い合わせから初回商談までは見えていますが、その後の継続接点が弱い可能性があります。",
      confidenceStatus: "estimated",
      evidence:
        "Web問い合わせから商談への導線はあるが、保守サービスへの接続が推定中心です。",
      followUpQuestion: "初回商談後に継続提案へ進む割合は確認できますか？",
      sortOrder: 0,
      createdAt: now,
    },
    {
      ...
      targetId: "node-data",
      title: "売上CSV",
      body: "売上CSVは継続契約や利益化の判断材料として、まだ施策導線へ接続できる資産です。",
      confidenceStatus: "needs_review",
      evidence: "データ資料ノードとして存在するが、施策判断への接続は未確認です。",
      followUpQuestion: "売上CSVから継続率や高単価化の兆候を確認できますか？",
      sortOrder: 1,
      createdAt: now,
    },
  ],
