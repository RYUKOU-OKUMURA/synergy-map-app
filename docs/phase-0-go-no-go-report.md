...
| P0-12 macOS / Windows確認     | 部分完了 | macOS dev build、DB、資料投入、Codex接続、PDF出力を確認。Windows実機は未確認で、確認項目と残リスクを文書化。 |
...
- Windows実機で`pnpm tauri dev`、DB保存、資料投入、Codex接続、PDF出力を確認する。
