...
コンサルタント専用に閉じない。経営者本人が、自分の頭の中にある事業構造を整理する用途も重視する。
...
5. AIが現状分析、施策候補、確認質問を出す。
6. Markdown / CSVで出力する。

MVP-1では、自由作図、共同編集、クライアントログイン、共有リンク、OCR、URL読み取り、SNS/API連携、会計API連携は対象外。
...
- 根拠、推測、要確認を画面上で分けること。
- マップだけで終わらず、施策カードと確認質問まで出すこと。
- 会議前、会議中、会議後、月次振り返りで使えること。
...
- `docs/synergy-map-design-mvp-1.md`
- `docs/ux-improvement-plan-initial-map-flow.md`
- `docs/implementation-plan-ux-onboarding.md`
...
- `docs/phase-0-go-no-go-report.md`
- `docs/phase-0-information-policy.md`
- `docs/phase-0-platform-verification.md`
- `docs/phase-0-sidecar-verification.md`
- `docs/phase-0-device-code-guide.md`
