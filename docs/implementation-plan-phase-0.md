...
- Windowsユーザー向け説明文は`docs/phase-0-device-code-guide.md`に記録。
...
- 詳細方針は`docs/phase-0-information-policy.md`に記録。
...
- macOS DB保存、サンプル資料投入、Codex stdio接続、schema付きturn、Typst PDF出力、React Flow PNG埋め込みを確認済み。
- `typst compile reports/phase-0/phase-0-report.typ reports/phase-0/phase-0-report.pdf`で2ページPDFを再生成。
- Windows実機はこの作業環境では確認できないため未実施。DB path、Codex shim、フォント、権限、sidecar起動の確認項目を`docs/phase-0-platform-verification.md`に記録。
